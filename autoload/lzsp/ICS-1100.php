...
$xmArr= array("F-"=>'181',"F"=>'181',"CL-"=>'182',"CL"=>'182',"SO4-"=>'190',"SO4"=>'190',"NO3-"=>'186',"NO3"=>'186',"NO3-N"=>'186',"PO4"=>'563',"NO2-N"=>'187',"NO2"=>'187',"P2O5"=>"563","HPO4-P"=>"563");
$quzhi_zt = $bhZt ='';
$zhi	 = array();
...
for($i=0;$i<count($arr);$i++){
	...
	//匹配项目名称后开始获取样品编号
	if(!empty($xmArr[$line])||stristr($line,'COMPONENT')){
		if(stristr($line,'COMPONENT')){
			$xm='';
		}else{
			$xm		= $xmArr[$line];
		}
