...
class PublicApp extends LIMS_Base {
	...
	*/
	 ...
	 * 描述: 自动跳转 信息提示 页面
	*/
	public function reto($content='', $url='', $class='info', $sec=1){
	...
	// show_message
	static function show_message($content, $class){
		echo '<div class="alert alert-'.$class.'"><p style="text-align:left"><strong>警示信息：</strong></p>'.$content.'</div>';
	}
}