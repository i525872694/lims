...
while( $row = $DB->fetch_assoc($res) ) {
	$tid_sql	= $DB->fetch_one_assoc("SELECT group_concat(`vid`) AS vid FROM `assay_order` WHERE `cyd_id`='{$row['id']}' AND `vid` in (121,187,186,198,114,104,118,119,'172','162','173','174','182','190','665','189','188') ");
	$tid_arr	= array();
