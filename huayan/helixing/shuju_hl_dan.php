...
if($jsleixin=='4'){
	...
	while($rs_select_cy_rec = $DB->fetch_assoc($select_cy_rec)){
		...
		//行模板，每个站点的详细信息
		$lines	.= "<tr><td>{$i}</td><td>{$rs_select_cy_rec['site_name']}</td><td>{$ion_result_arr['172']['old_vd0']}</td><td>{$ion_result_arr['162']['old_vd0']}</td><td>{$ion_result_arr['173']['old_vd0']}</td><td>{$ion_result_arr['174']['old_vd0']}</td><td>{$ion_result_arr['182']['old_vd0']}</td><td>{$ion_result_arr['190']['old_vd0']}</td><td>{$ion_result_arr['665']['old_vd0']}</td><td>{$ion_result_arr['189']['old_vd0']}</td><td>{$ion_result_arr['188']['old_vd0']}</td><td>{$ion_result_arr['count_result']}</td><td>{$ion_result_arr['result']}</td></tr>";
	}
