...
<?php $i=0; foreach($data as $table_key => $ji_lu){?>
	<div style="text-align:center;width:20cm;margin:0 auto;">单位名称：<?php echo $u['hub_name'];?><div style="float:right">打印时间：<?php echo date('Y-m-d');?></div></div>
	<h3 class="header smaller center title">库房物品一览表</h3>
	<table class="single" style="width:20cm;text-align:center" align="center">
		<tr>
			<td width="20%">序&nbsp;&nbsp;号</td>
			<td width="30%">名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</td>
			<td width='20%'>条码号</td>
