...
foreach($qx_one_arr as $key=>$value){
		...
		$checkboxQx	.= "<label class='bianse' style='margin-bottom:1px;margin-left:1px;height:43px;line-height:43px;width:130px;border:0px #D7D7D7 solid;'><input type='checkbox' groupid$group_id='yes'group='$group_str' name='qx[]' value='".$key."' style='display:none;'  onclick=\"return false;\" />".$value."</label>";
	}
}
echo disp("user_manager/user_manage_user_new.html");
?>
