...
$trade_global['daohang'][] = array('icon'=>'','html'=>'仪器管理','href'=>"{$rooturl}/app_modal/yiqi_list.php");
$trade_global['daohang'][] = array('icon'=>'','html'=>'仪器文件','href'=>$current_url);
...
$id = $_GET['id'];
//循环数据 查看
$info=$DB->query("select * from `files` where `fzx_id`='$u[fzx_id]' and `type`='$type' and `join_id`='$id'");
$i=1;
